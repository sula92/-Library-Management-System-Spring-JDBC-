...
public class BookController {
   ...
   // ApplicationContext context = new ClassPathXmlApplicationContext("com/sula/resources/Beans.xml");
    @Autowired
    BookDAO bookDAO = DAOFactory.getBookDAO();//(BookDAOImpl) context.getBean("bookdaoimpl");
    ...
    public void btnReportOnAction(ActionEvent event) throws JRException {
        ...
        JasperDesign jasperDesign = JRXmlLoader.load(BookController.class.
                getResourceAsStream("/com/sula/reports/books.jrxml"));
