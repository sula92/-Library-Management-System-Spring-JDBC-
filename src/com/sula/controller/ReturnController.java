...
public class ReturnController implements Initializable {
    ...
    ReturnDAO returnDAO= DAOFactory.getReturnDAO();//(ReturnDAO) context.getBean("returndaoimpl");
    QueryDAO queryDAO= DAOFactory.getQueryDAO();//(QueryDAO) context.getBean("querydaoimpl");
    BorrowDAO borrowDAO= DAOFactory.getBorrowDAO();//(BorrowDAO) context.getBean("borrowdaoimpl");
