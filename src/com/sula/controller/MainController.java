...
public class MainController implements Initializable {
    ...
    private void navigate(MouseEvent event) throws IOException {
        if (event.getSource() instanceof ImageView) {
            ...
            switch (icon.getId()) {
                case "imgCus":
                    root = FXMLLoader.load(this.getClass().getResource("/com/sula/view/Member.fxml"));
                    break;
                case "imgBook":
                    root = FXMLLoader.load(this.getClass().getResource("/com/sula/view/Book.fxml"));
                    break;
                case "imgBorrow":
                    root = FXMLLoader.load(this.getClass().getResource("/com/sula/view/Borrow.fxml"));
                    break;
                case "imgReturn":
                    fxmlLoader = new FXMLLoader(this.getClass().getResource("/com/sula/view/Return.fxml"));
